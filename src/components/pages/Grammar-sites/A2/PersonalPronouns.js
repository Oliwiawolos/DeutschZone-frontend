...
function PersonalPronouns() {
  return (
    ...
    <div className="conjugation-container">
      ...
      <p>Personal Pronoun replaces other parts of speech and refers to people, objects and situations. Thanks to pronouns, there is no need to repeat the same noun multiple times but it can be replaced with the appropriate pronoun.</p>
      <h3><LooksOneIcon style={{fontSize: '1.7rem', marginBottom:'-4%'}} />Persons</h3>
